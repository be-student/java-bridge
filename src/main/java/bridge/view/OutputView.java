...
public class OutputView {
     ...
     */
    public void printMap(Bridge bridge, Visited visited) {
        System.out.println(visited.printVisited(bridge));
    }
    ...
    public void printResult(BridgeGameResultDto bridgeGameResultDto) {
        String result = bridgeGameResultDto.getSuccessOrFailure();

        System.out.println("최종 게임 결과");
        System.out.println(bridgeGameResultDto.getFinalResult());
